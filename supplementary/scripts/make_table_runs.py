...
rows = [
    ...
    ("c", r"1:1", r"$10^5$", r"1C+CA (3375+1125) / CA (1125)$^\dagger$"),
    ("d", r"1:1", r"$2\times10^4$", r"1C+CA (750+250) / CA (250)$^\dagger$"),
    ("e", r"1:1", r"$10^5$", r"CA (500)"),
    ("f", r"1:1", r"$2\times10^4$", r"CA (250)"),
    ("fig3", r"1:1", r"$2\times10^4$", r"1C+CA (3375+1125) / CA (1125)$^\dagger$"),
    ("L3.3", r"1:1, $\rho\approx0.73$", r"$2\times10^4$", r"CA (250)"),
    ("hex", r"$2:\sqrt{3}$", r"$2\times10^4$", r"CA (250)"),
]
labels = {"a": "2, 5a", "b": "5b", "c": "5c", "d": "5d", "e": "5e", "f": "5f, 6 (left)",
          "fig3": "3", "L3.3": "6 (right)", "hex": "S3, S4"}
